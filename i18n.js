(function (root, factory) {
    ...
    const en = Object.freeze({
        ...
        'batch.retry': 'Retry',
        'batch.cancel': 'Cancel',
        'duplicates.heading': 'Probable duplicate review',
        'duplicates.phash': 'pHash distance',
        'duplicates.dhash': 'dHash distance',
        'duplicates.recheck': 'Recheck',
        'duplicates.none': 'No probable duplicates at these thresholds.',
        'duplicates.advisory': 'Advisory only: visual similarity is not identity or authenticity proof. Nothing is removed or deselected.',
    ...
    const es = Object.freeze({
        ...
        'duplicates.heading': 'Revisión de duplicados probables',
        'duplicates.phash': 'Distancia pHash',
        'duplicates.dhash': 'Distancia dHash',
        'duplicates.recheck': 'Volver a comprobar',
        'duplicates.none': 'No hay duplicados probables con estos umbrales.',
        'duplicates.advisory': 'Solo orientativo: la similitud visual no demuestra identidad ni autenticidad. Nada se elimina ni se desmarca.',
